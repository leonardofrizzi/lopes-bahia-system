  ...
  const externalLinks: ExternalLink[] = [
    {
      ...
      url: "https://prontos.lopesnet.com.br/"
    },
    {
      name: "LopesNet Contatos",
        ...
        <ul className="space-y-3">
          ...
          {externalLinks.map((link) => (
            <li key={link.name} className="mt-2">
              ...
              >
                <span className="mr-3">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#eb194b]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
